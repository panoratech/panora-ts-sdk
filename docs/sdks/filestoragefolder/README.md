...
* [getFolders](#getfolders) - List a batch of Folders
* [addFolder](#addfolder) - Create a Folder
* [getFolder](#getfolder) - Retrieve a Folder
...
**Promise\<[operations.AddFolderResponse](../../models/operations/addfolderresponse.md)\>**
### Errors
