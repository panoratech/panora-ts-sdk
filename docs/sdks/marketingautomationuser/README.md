...
* [addMarketingAutomationUser](#addmarketingautomationuser) - Create a User
...
**Promise\<[operations.AddMarketingAutomationUserResponse](../../models/operations/addmarketingautomationuserresponse.md)\>**
### Errors
