...
* [addIncomeStatements](#addincomestatements) - Add a batch of IncomeStatements
...
**Promise\<[operations.AddIncomeStatementsResponse](../../models/operations/addincomestatementsresponse.md)\>**
### Errors
