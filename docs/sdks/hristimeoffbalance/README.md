...
* [addTimeoffBalances](#addtimeoffbalances) - Add a batch of TimeoffBalances
...
**Promise\<[operations.AddTimeoffBalancesResponse](../../models/operations/addtimeoffbalancesresponse.md)\>**
### Errors
