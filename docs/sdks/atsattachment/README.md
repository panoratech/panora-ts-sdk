...
* [addAtsAttachments](#addatsattachments) - Add a batch of Attachments
...
**Promise\<[operations.AddAtsAttachmentsResponse](../../models/operations/addatsattachmentsresponse.md)\>**
### Errors
