...
* [addJobInterviewStages](#addjobinterviewstages) - Add a batch of JobInterviewStages
...
**Promise\<[operations.AddJobInterviewStagesResponse](../../models/operations/addjobinterviewstagesresponse.md)\>**
### Errors
