...
* [addRejectReasons](#addrejectreasons) - Add a batch of RejectReasons
...
**Promise\<[operations.AddRejectReasonsResponse](../../models/operations/addrejectreasonsresponse.md)\>**
### Errors
