...
* [addVendorCredits](#addvendorcredits) - Add a batch of VendorCredits
...
**Promise\<[operations.AddVendorCreditsResponse](../../models/operations/addvendorcreditsresponse.md)\>**
### Errors
