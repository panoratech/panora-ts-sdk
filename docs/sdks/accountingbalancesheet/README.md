...
* [addBalanceSheets](#addbalancesheets) - Add a batch of BalanceSheets
...
**Promise\<[operations.AddBalanceSheetsResponse](../../models/operations/addbalancesheetsresponse.md)\>**
### Errors
